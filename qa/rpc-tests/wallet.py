...
#   c) node1 mines 32 blocks, so now node 0 has 60001xuez, node 1 has 4250xuez, node2 has none.
#   d) node0 sends 601 xuez to node2, in two transactions (301 xuez, then 300 xuez).
