...
This mechanism has been integrated into Bitcore-Node-XUEZ which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xuez/insight-api-xuez#web-socket-api](https://github.com/xuez/insight-api-xuez#web-socket-api) 
* API: [https://github.com/xuez/insight-api-xuez#swifttx-transactions](https://github.com/xuez/insight-api-xuez#swifttx-transactions) 
